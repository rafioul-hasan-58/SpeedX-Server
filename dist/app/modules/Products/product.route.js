...
router.patch('/update-product/:id', (0, auth_1.default)(['admin']), (0, validateRequest_1.default)(product_validation_1.productValidations.updateProductValidationSchema), product_controller_1.productController.updateProduct);
router.patch('/remove-product-image', product_controller_1.productController.removeImage);
