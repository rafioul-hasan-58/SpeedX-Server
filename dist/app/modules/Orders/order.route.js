...
router.post('/add-order', (0, auth_1.default)(user_constant_1.UserRole.CUSTOMER), (0, validateRequest_1.default)(order_validation_1.orderValidations.createOrderValidationSchema), order_controller_1.orderController.createOrderIntoDb);
...
router.get('/get-my-orders', (0, auth_1.default)(user_constant_1.UserRole.CUSTOMER), order_controller_1.orderController.getMyOrders);
