...
if (!index_1.default.ai_api.gemini_api_key) {
    throw new Error("GEMINI_API_KEY is missing in .env");
}
const genAI = new generative_ai_1.GoogleGenerativeAI(index_1.default.ai_api.gemini_api_key);
...
exports.default = exports.geminiModel;
